...
class BlocsTest extends TestCase
{
    ...
    {
        is_file($this->testDir.'/expected.html') || is_file($this->testDir.'/expected.html') || file_put_contents($this->testDir.'/expected.html', $this->actual);
    }
}
